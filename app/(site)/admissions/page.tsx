...
export default async function AdmissionsPage(){
  ...
  if (siteConfig?.template.id === "design-2") return <Design2ContentPage title="Admissions" content="Admissions are open for the upcoming academic session. Explore the admission process and begin your application with our school team." imageUrl="/about-school.jpg" />;
  return <div className="bg-paper py-16"><div className="mx-auto max-w-3xl px-6"><p className="font-mono text-xs uppercase tracking-[.2em] text-gold-600">Admissions</p><h1 className="mt-4 font-display text-4xl text-ink-700">Start your application</h1><p className="mt-4 text-slate/70">Verify your phone number first, then complete the application in two simple steps.</p><AdmissionForm/></div></div>;
}
