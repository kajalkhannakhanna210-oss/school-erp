  ...
  return (
    <div className="lg:hidden">
      ...
      {open && <div className="fixed inset-0 z-50">
        ...
        <nav aria-label="Dashboard navigation" className="mobile-menu-drawer absolute left-0 top-0 flex h-full w-[min(19rem,calc(100vw-1.25rem))] flex-col bg-ink-900 text-white shadow-2xl">
