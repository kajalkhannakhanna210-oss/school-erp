...
export async function saveSeoMetadata(input: { path: string; title: string; description: string; keywords: string; canonical_path: string; og_title: string; og_description: string; og_image: string; indexable: boolean }) {
