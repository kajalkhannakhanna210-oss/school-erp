...
- Name: add-school.spec.js >> Add School page >> blocks an empty submission and reports the first required field
- Location: tests\e2e\add-school.spec.js:54:3
...
Call log:
  - waiting for getByLabel(/email or mobile number/i)
    2 × waiting for "http://localhost:3002/admin/login" navigation to finish...
      - navigated to "http://localhost:3002/admin/login"
